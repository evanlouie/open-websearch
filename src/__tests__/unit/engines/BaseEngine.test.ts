...
describe('BaseEngine', () => {
    ...
    describe('search', () => {
        test.skip('executes search and returns results - SKIPPED: requires real browser', async () => {
        ...
        test.skip('respects limit parameter - SKIPPED: requires real browser', async () => {
        ...
        test.skip('releases page after search - SKIPPED: requires real browser', async () => {
    ...
    describe('healthCheck', () => {
        test.skip('returns true when engine is accessible - SKIPPED: requires real browser', async () => {
        ...
        test.skip('returns false on timeout - SKIPPED: requires real browser', async () => {
