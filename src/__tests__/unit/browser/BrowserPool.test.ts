...
describe('BrowserPool', () => {
    ...
    describe('Pool Mode', () => {
        test('maintains pool of pages up to poolSize', async () => {
        ...
        test('closes pages when pool exceeds poolSize', async () => {
            const pool = new BrowserPool({ mode: 'pool', poolSize: 2, headless: true });
    ...
    describe('Per-Search Mode', () => {
        ...
        test('closes page immediately when released', async () => {
            const pool = new BrowserPool({ mode: 'per-search', headless: true });
    ...
    describe('Cleanup', () => {
        test.skip('closes all pages on close() - SKIPPED: slow in test environment', async () => {
            const pool = new BrowserPool({ mode: 'shared', headless: true });
    ...
    describe('Error Handling', () => {
        test('handles browser disconnect gracefully', async () => {
            const pool = new BrowserPool({ mode: 'shared', headless: true });
